package com.delveye.dpsn.gateway.model;
...
/**
 * Represents a Token that includes an access token, its expiration time, and a
 * refresh token.
 * Provides utility methods to check if a token is a Bearer token and to extract
 * the JWT from an authorization header.
 */
@Getter
@Builder
public class Token {
