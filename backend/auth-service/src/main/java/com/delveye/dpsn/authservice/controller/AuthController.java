package com.delveye.dpsn.authservice.controller;
...
/**
 * Controller named {@link AuthController} for handling authentication-related
 * operations.
...
public class AuthController {
	 ...
	 *
	 * @param tokenInvalidateRequest the token invalidate request containing the
