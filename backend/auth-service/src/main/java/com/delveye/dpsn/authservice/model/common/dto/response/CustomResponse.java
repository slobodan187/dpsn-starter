package com.delveye.dpsn.authservice.model.common.dto.response;
...
/**
 * Represents a generic response object named {@link CustomResponse<T>} with
 * standardized fields.
 *
...
public class CustomResponse<T> {
	...
	/**
	 * Default successful response with HTTP OK status and success indicator set to
	 * true.
	 */
