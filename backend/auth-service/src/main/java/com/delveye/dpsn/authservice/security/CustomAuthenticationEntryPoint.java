package com.delveye.dpsn.authservice.security;

import com.delveye.dpsn.authservice.exception.CustomError;
 ...
 * This class handles authentication errors by returning a custom JSON error
 * response.
 * It is used to respond with an appropriate error message when an
 * unauthenticated request is made.
 */
@Component
public class CustomAuthenticationEntryPoint implements AuthenticationEntryPoint {
	...
	/**
	 * Commences the authentication process by sending an unauthorized error
	 * response.
	 *
	 ...
	 * @param authenticationException the exception that triggered the
