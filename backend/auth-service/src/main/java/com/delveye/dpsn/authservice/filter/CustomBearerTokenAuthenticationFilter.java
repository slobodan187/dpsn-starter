package com.delveye.dpsn.authservice.filter;
...
import com.delveye.dpsn.authservice.model.auth.Token;

import java.io.IOException;

/**
 * Filter named {@link CustomBearerTokenAuthenticationFilter} for authenticating
