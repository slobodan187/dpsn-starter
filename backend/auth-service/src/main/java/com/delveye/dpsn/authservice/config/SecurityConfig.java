package com.delveye.dpsn.authservice.config;
...
import com.delveye.dpsn.authservice.filter.CustomBearerTokenAuthenticationFilter;
import com.delveye.dpsn.authservice.security.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
	 ...
	 * @param customBearerTokenAuthenticationFilter the custom filter for Bearer
